      ...
      <div className="pour-sticky">
        ...
        <svg id="pour-svg" viewBox="0 0 600 760" xmlns="http://www.w3.org/2000/svg">
          ...
          <g id="ps-bot-grp" ref={bottleGrpRef}>
            ...
            <use href="#lion-logo" x="300" y="292" />

            {/* Brand Texts on Dark Brown */}
            <text x="300" y="348" text-anchor="middle" fontFamily="Inter,sans-serif" fontWeight="800" fontSize="13.5" fill="#ffffff" letterSpacing="0.8">VIN</text>
            <text x="300" y="362" text-anchor="middle" fontFamily="Inter,sans-serif" fontWeight="800" fontSize="13.5" fill="none" stroke="#ffffff" strokeWidth="2.2" letterSpacing="0.8">NKOLO</text>
            <text x="300" y="362" text-anchor="middle" fontFamily="Inter,sans-serif" fontWeight="800" fontSize="13.5" fill="none" stroke="#311b0b" strokeWidth="0.8" letterSpacing="0.8">NKOLO</text>
            <text x="300" y="376" text-anchor="middle" fontFamily="Inter,sans-serif" fontWeight="800" fontSize="13.5" fill="none" stroke="#ffffff" strokeWidth="2.2" letterSpacing="0.8">MBOKA</text>
            <text x="300" y="376" text-anchor="middle" fontFamily="Inter,sans-serif" fontWeight="800" fontSize="13.5" fill="none" stroke="#311b0b" strokeWidth="0.8" letterSpacing="0.8">MBOKA</text>
            <text x="300" y="386" text-anchor="middle" fontFamily="Inter,sans-serif" fontSize="4.5" fill="#d4af37" letterSpacing="0.2">GINGER-BASED ALCOHOLIC BEVERAGE</text>
            
            {/* Red Swahili banner */}
            <rect x="231" y="398" width="138" height="22" fill="#b71c1c" />
            <text x="300" y="411" text-anchor="middle" fontFamily="Inter,sans-serif" fontWeight="700" fontSize="4.2" fill="#ffffff" letterSpacing="0.1">NGUVU YA SIMBA, FAHARI YA TANZANIA</text>
